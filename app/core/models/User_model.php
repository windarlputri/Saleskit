...
class User_model extends CI_Model
{
	...
	function user_cabang($where=array(),$order="Branch ASC")
	{
		$d=$this->user->get_data('KODE_CABANG',$where,$order);
		return $d;
	}
	...
	function user_add($roleID,$username,$password,$email,$full_name,$nick_name=NULL,$avatar=NULL,$status=1,$cabang)
	{
		$output=array();
	...
	function user_edit($userID,$roleID,$username,$password='',$email,$full_name,$nick_name=NULL,$avatar=NULL,$status=0,$cabang)
	{
		$output=array();
